...
urlpatterns = [
    ...
    url(r'^ingredientcategories/(?P<pk>[0-9]+)/$', views.IngredientCategoryDetail.as_view()),
    url(r'^ingredients/$', views.IngredientList.as_view()),
    url(r'^ingredients/(?P<pk>[0-9]+)/$', views.IngredientDetail.as_view()),
    url(r'^itemsordered/$', views.ItemOrderedList.as_view()),
    url(r'^itemsordered/(?P<pk>[0-9]+)/$', views.ItemOrderedDetail.as_view()),
    url(r'^itemingredients/$', views.ItemIngredientList.as_view()),
